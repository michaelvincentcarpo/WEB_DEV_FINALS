...
class HomeController extends Controller
{
    ...
    public function insertData(Request $request){
        ...
        DB::INSERT("INSERT into tblbooking_info(lname,fname,barangay,municipality,province,phone,email,cottage_no,kids,adult,senior,date_of_reg,time_,start,end_,cottage_s,cottage_m,cottage_l,venue)VALUES(?,?,?,?,?,?,?,?,?)", [$lname,$fname,$barangay,$municipality,$province,$phone,$email,$date_of_reg,]);
        $users =  DB::SELECT("SELECT * FROM tblbooking_info");
        return view('home',['users' => $users]);
